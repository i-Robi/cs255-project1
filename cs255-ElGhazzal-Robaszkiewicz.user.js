...
/* Function: CBCMac
 * ----------------
 * Takes as input a cipherText, and two keys. Computes the tag
 * generated by this input using CBCMac.
 */
...
function GenerateKey(group) {
  ...
  // for MAC
  var keylenMAC = 4;
  var key1 = GetRandomValues(keylenMAC);
  key1 = sjcl.codec.base64.fromBits(key1);
  var key2 = GetRandomValues(keylenMAC);
  key2 = sjcl.codec.base64.fromBits(key2);
  keys[group] = key1 + key2 + stringkey;
  SaveKeys();
}
